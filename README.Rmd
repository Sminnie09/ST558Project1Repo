...
```{r position numeric summary L, echo = TRUE}
SkatersTable("L")
```

```{r position numeric summary C, echo = TRUE}
SkatersTable("C")
```

```{r position numeric summary D, echo = TRUE}
SkatersTable("D")
```

```{r position numeric summary R, echo = TRUE}
SkatersTable("R")
```

## Barplot

```{r Team Totals bar plot, echo = TRUE, message = FALSE}
library(ggplot2)
